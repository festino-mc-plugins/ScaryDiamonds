...
public class AmethystChunk {
	...
	private final int minY; // all sections has non-negative index
	public final Chunk chunk;
	public long lastUpdate;
	// contains bit array: section has been scanned or not
	...
	private int yToSection(int y) {
		// convert world y to non-negative y
		y -= minY;
	...
	{
		if (!snap.isSectionEmpty(part * PART_BITS + bitN)) {
			int yBegin = minY + (part * PART_BITS + bitN) * 16;
			int yEnd = yBegin + 16;
